        ...
        return (
            <div className="container mx-auto px-2 mt-[40px] text-center">
                <div className="border border-secundary rounded-md p-6">
                    ...
                    <button onClick={() => window.location.reload()} className="mt-4 bg-secundary text-black-a px-6 py-2 rounded-full font-nsbold active:opacity-70 active:scale-90 transition-all duration-200">Reintentar</button>
                </div>
            </div>
        );
    }
